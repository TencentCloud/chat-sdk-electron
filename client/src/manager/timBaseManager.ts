...
const TimBaseManager = {
    callExperimentalAPI: () => {
        ...
        //         request_internal_operation:TIMInternalOperation.kTIMInternalOperationInitLocalStorage,
    ...
    TIMLogin: () => {
        let obj :loginParam = {
            userID:"daisy",
            userSig: "eJwtzM0KgkAYheF7mW0h868jtKiFgiVRk0TLqRnlwwpRyyK690xdnufA*0GHjfaerkYhoh5G82GDdfcWchjYGmje09HY0lQVWBQSjjEJfCbo*LhXBbXrXQhBMcajtnD7m5Sc*gGhaqpA0Xe7MpXddX90uwcvUmmyZJmoeBuJ2J6ZopfVepZFOddMnxbo*wMkajBc",
            userData:"1234",
        }
