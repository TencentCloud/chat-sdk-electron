...
static const char* kTIMConvC2CReadTimestamp         = "conv_c2c_read_timestamp";        // uint64, 只读, C2C 会话已读消息时间戳（从 7.1 版本开始支持）
...
static const char* kTIMCreateGroupParamAddOption        = "create_group_param_add_option";          // uint [TIMGroupAddOption](),   只写(选填),申请加群审批选项，默认为Any
static const char* kTIMCreateGroupParamApproveOption    = "create_group_param_approve_option";      // uint [TIMGroupAddOption](), 只写（选填），邀请进群审批选项，默认为Any
...
static const char* kTIMGroupDetailInfoCreateTime       = "group_detail_info_create_time";        // uint,   只读, 群组创建时间
static const char* kTIMGroupDetailInfoInfoSeq          = "group_detail_info_info_seq";           // uint,   只读, 群资料的Seq，群资料的每次变更都会增加这个字段的值
static const char* kTIMGroupDetailInfoLastInfoTime     = "group_detail_info_last_info_time";     // uint,   只读, 群组信息最后修改时间
...
static const char* kTIMGroupDetailInfoOnlineMemberNum  = "group_detail_info_online_member_num";  // uint,   只读, 群组在线成员数量
