...
import { userProfile } from "../interface/advanceMessageInterface";
...
/**
 * @param friend_result_identifier friend_result_identifier 关系链操作的用户ID
 * @param friend_result_code friend_result_code 错误码
 * @param friend_result_desc friend_result_desc 关系链操作失败的详细描述
 */
interface FriendResult {
    friend_result_identifier: string;
    friend_result_code: number;
    friend_result_desc: string;
}

/**
 * @param friendship_check_friendtype_result_identifier friendship_check_friendtype_result_identifier:被检测的好友UserID
 * @param friendship_check_friendtype_result_relation friendship_check_friendtype_result_relation:[TIMFriendCheckRelation]
 * @param friendship_check_friendtype_result_code friendship_check_friendtype_result_code: 错误码
 * @param friendship_check_friendtype_result_desc friendship_check_friendtype_result_desc: 检测好友失败的描述信息
 */
interface CheckFriendTypeResult {
    friendship_check_friendtype_result_identifier: string;
    friendship_check_friendtype_result_relation: TIMFriendCheckRelation;
    friendship_check_friendtype_result_code: number;
    friendship_check_friendtype_result_desc: string;
}

interface FriendGroupInfo {
    friend_group_info_name: string;
    friend_group_info_count: number;
    friend_group_info_identifier_array: Array<string>;
}
...
interface PendencyPage {
    pendency_page_start_time: number;
    pendency_page_unread_num: number;
    pendency_page_current_seq: number;
    pendency_page_pendency_info_array: FriendAddPendencyInfo[];
}

interface FriendInfoGetResult {
    friendship_friend_info_get_result_identifier: string;
    friendship_friend_info_get_result_relation_type: TIMFriendshipRelationType;
    friendship_friend_info_get_result_error_code: number;
    friendship_friend_info_get_result_error_message: string;
    friendship_friend_info_get_result_field_info: Array<FriendProfile>;
}
