 ...
 * @param group_detial_info_custom_info group_detial_info_custom_info: 请参考[GroupInfoCustemString]
 */
interface GroupDetailInfo {
    group_detial_info_group_id: string;
    group_detial_info_group_type: TIMGroupType;
    ...
    group_detial_info_add_option: TIMGroupAddOption;
    group_detial_info_online_member_num: number;
    group_detial_info_visible: number;
    group_detial_info_searchable: number;
    group_detial_info_is_shutup_all: boolean;
    group_detial_info_owener_identifier: string;
    group_detial_info_is_support_topic: boolean;
...
interface GetMemberInfoResult {
    ...
    group_get_memeber_info_list_result_info_array: Array<GroupMemberInfo>;
}
...
interface SearchMemberResult {
    ...
    group_search_member_result_menber_info_list: Array<GroupMemberInfo>;
}
