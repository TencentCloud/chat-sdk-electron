    ...
    TIMMsgFindMessages(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                if (code === 0) {
                    let param: Array<Json_value_msg> = JSON.parse(json_params);
            ...
            const cb: CommonCallbackFuns = (
                ...
                if (code === 0) {
                    const us = this._cache
                        ...
                        ?.get(now)?.user_data;
                    let param: Json_value_msg = JSON.parse(json_params);
                    resolve({ code, desc, json_params: param, user_data: us });
                } else {
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                const us = this._cache
                    ...
                    ?.get(now)?.user_data;
                if (code === 0) {
                    let param: DownloadElemResult = JSON.parse(json_params);
                    resolve({ code, desc, json_params: param, user_data: us });
                } else reject(this.getErrorResponse({ code, desc }));
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                const us = this._cache
                    ...
                    ?.get(now)?.user_data;
                if (code === 0) {
                    let param: Array<BatchSendResult> = JSON.parse(json_params);
                    resolve({ code, desc, json_params: param, user_data: us });
                } else reject(this.getErrorResponse({ code, desc }));
