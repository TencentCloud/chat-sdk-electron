    ...
    async TIMConvGetConvList(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFun = (
                ...
                let arrayparam: Array<convInfo> = JSON.parse(json_param);
                if (code === 0) {
    ...
    TIMConvGetConvInfo(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFun = (
                ...
                let param: Array<convInfo> = JSON.parse(json_param);
                if (code === 0) {
                    resolve({ code, desc, json_param: param, user_data });
                } else {
                    reject({ code, desc, json_param: param, user_data });
    ...
    TIMConvGetTotalUnreadMessageCount(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFun = (
                ...
                let param: totalUnreadCountResult = JSON.parse(json_param);
                if (code === 0) {
                    resolve({ code, desc, json_param: param, user_data });
                } else {
                    reject({ code, desc, json_param: param, user_data });
