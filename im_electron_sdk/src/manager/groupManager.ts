    ...
    TIMGroupCreate(
        ...
        return new Promise((resolve, reject) => {
            ...
            const successCallback: CommonCallbackFun = (
                ...
                let param: CreateGroupResult = JSON.parse(json_param);
                code === 0
    ...
    TIMGroupGetJoinedGroupList(
        ...
        return new Promise((resolve, reject) => {
            ...
            const successCallback: CommonCallbackFun = (
                ...
                let param: Array<GroupInfo> = JSON.parse(json_param);
                code === 0
                    ? resolve({ code, desc, json_param: param, user_data })
                    : reject(this.getErrorResponse({ code, desc }));
    ...
    TIMGroupGetOnlineMemberCount(
        ...
        return new Promise((resolve, reject) => {
            ...
            const successCallback: CommonCallbackFun = (
                ...
                let param: GetOnlineMemberCountResult = JSON.parse(json_param);
                code === 0
                    ? resolve({ code, desc, json_param: param, user_data })
                    : reject(this.getErrorResponse({ code, desc }));
    ...
    TIMGroupSearchGroupMembers(
        ...
        return new Promise((resolve, reject) => {
            ...
            const successCallback: CommonCallbackFun = (
                ...
                let param: Array<SearchMemberResult> = JSON.parse(json_param);
                code === 0
                    ? resolve({ code, desc, json_param: param, user_data })
                    : reject(this.getErrorResponse({ code, desc }));
        ...
        return new Promise((resolve, reject) => {
            ...
            const successCallback: CommonCallbackFun = (
                ...
                let param: Array<MessageReceipt> =
                    json_param == ""
                        ? []
                        : JSON.parse(JSON.stringify(json_param));
                code === 0
                    ? resolve({ code, desc, json_param: param, user_data })
                    : reject(this.getErrorResponse({ code, desc }));
