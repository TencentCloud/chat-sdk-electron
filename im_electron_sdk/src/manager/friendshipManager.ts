    ...
    TIMFriendshipGetFriendProfileList(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                let param: Array<FriendProfile> = JSON.parse(json_params);
                if (code === 0) {
    ...
    TIMFriendshipAddFriend(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                let param: FriendResult = JSON.parse(json_params);
                if (code === 0)
                    resolve({ code, desc, json_params: param, user_data });
    ...
    TIMFriendshipDeleteFriend(
        ...
        return new Promise((resolve, reject) => {
            const cb: CommonCallbackFuns = (
                ...
                let param: Array<FriendResult> = JSON.parse(json_params);
                if (code === 0)
                    resolve({ code, desc, json_params: param, user_data });
                else reject(this.getErrorResponse({ code, desc }));
    ...
    TIMFriendshipGetPendencyList(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                let param: PendencyPage = JSON.parse(json_params);
                if (code === 0)
                    resolve({ code, desc, json_params: param, user_data });
                else reject(this.getErrorResponse({ code, desc }));
    ...
    TIMFriendshipGetFriendsInfo(
        ...
        return new Promise((resolve, reject) => {
            ...
            const cb: CommonCallbackFuns = (
                ...
                let param: Array<FriendInfoGetResult> = JSON.parse(json_params);
                if (code === 0)
                    resolve({ code, desc, json_params: param, user_data });
                else reject(this.getErrorResponse({ code, desc }));
